    ...
    >
      <div className="flex flex-col items-center justify-center space-y-2">
        ...
        <p className="text-gray-400">
          Actually change your financial situation — dont just track your
          current one.
        </p>
      </div>

      <div className="mt-8 grid sm:grid-cols-2 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
        {features.map((feature) => {
          return (
            <div
              key={feature.title}
              className="border-b border-gray-400/10 p-4"
            >
