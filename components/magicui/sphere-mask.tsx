  ...
  return (
    <div
      className={cn(
        ...
        // before
        "before:absolute before:inset-0 before:h-full before:w-full before:opacity-70 before:[background-image:radial-gradient(circle_at_bottom_center,var(--color),transparent_70%)]",
